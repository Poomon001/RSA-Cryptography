...
## Results
- We successfully reduce the number of instruction by 39,238 instructions between main.c and optimized_no_lookup_main.c (improvement of 12.6 % of the total instruction). 
